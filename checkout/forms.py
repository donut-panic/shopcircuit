...
class AddOrderInfoForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {'order_by': forms.TextInput(attrs={'class': 'form-control text-center bg-white'}),
